...
document.querySelector('.b-4').onclick = () => {
  let instance = new Test(1);
  console.log(instance.someMethod());
  console.log(instance.someMethod2()); // по this  всё понятно но не понятно больше по стрелочным функция почему this  так ведёт себя в рамках этого задания
};
